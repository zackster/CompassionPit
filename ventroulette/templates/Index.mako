...
<div id="container"><!-- Start Container DIV -->
    ...
    <div id="main"><!-- Start Main DIV -->
    	<div id="column_left"><!-- Start Left Column DIV -->
       		<!-- Subheader Goes Here -->
      		<h2>Connect with somebody who will listen</h2>
       		<!-- Paragraph Of Text Goes Here -->
    		<p>You want to share your feelings, but you can't talk to somebody you know - because let's face it, it's possible that they'll judge you for it, or use it against you in the future. CompassionPit is the solution to this: get anonymously connected to another compassionate human from around the world.</p>
